...
ActiveRecord::Schema.define(version: 20160222003729) do
  ...
  add_index "cargo_empleados", ["cargo_cod"], name: "cargo_empleado_pk", unique: true, using: :btree
  ...
  add_foreign_key "empleados", "cargo_empleados", column: "cargo_cod", primary_key: "cargo_cod", name: "fk_empleados_tiene_cargo_em", on_update: :cascade, on_delete: :restrict
end
